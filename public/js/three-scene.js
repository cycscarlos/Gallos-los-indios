// ========================================
// THREE-SCENE.JS - Escena Three.js base reutilizable
// Proporciona escena, cámara, renderer, partículas y arena
// ========================================
...
window.ThreeScene = (function() {
    ...
    return { init, createParticles, createArena, getScene, getCamera, getRenderer };
})();
