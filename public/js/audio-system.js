// ========================================
// AUDIO-SYSTEM.JS - Sistema de audio unificado
// Usado por todas las páginas con botón sound-toggle
// ========================================
...
window.AudioSystem = (function() {
    ...
    return { initAudio, playClickSound, createAmbientSound };
})();

// Compatibilidad: exponer playClickSound como global para código legacy
window.playClickSound = window.AudioSystem.playClickSound;
